...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/DataShastra/login.css">
</head>
<body>
<div class="container" id="signup" style="display:none;">
    <h1 class="form-title">Register</h1>
    <form method="post" action="http://localhost/DataShastra/register.php">
...
<div class="container" id="signIn">
    ...
    <div class="links">
      ...
      <script src="http://localhost/DataShastra/scripts.js"></script>
</body>
</html>